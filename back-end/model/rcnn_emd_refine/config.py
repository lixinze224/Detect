...
root_dir = '../../'
'''
 '/home/prir1005/lixinze'作为优先搜索路径
 '/home/prir1005/.prirMSERDataMountPoint2/PublicData/CrowdHuman'
'''
...
class Crowd_human:
    ...
    root_temp = os.path.abspath('../../../')
    root_temp = os.path.join(root_temp,'.prirMSERDataMountPoint2/PublicData')
    root_folder = os.path.join(root_temp,'CrowdHuman')
    image_folder = os.path.join(root_temp,'CrowdHuman/val2017')
    train_source = os.path.join(root_temp,'CrowdHuman/annotations/annotation_train.odgt')
    eval_source = os.path.join(root_temp,'CrowdHuman/annotations/annotation_val.odgt')
